 ...
 include("sess_check.php");
	...
	if(isset($_GET['pot'])) {
		$sql = "SELECT potongan.*, karyawan.* FROM potongan, karyawan 
				WHERE potongan.karyawan_id=karyawan.karyawan_id 
				AND potongan.pot_id='". $_GET['pot'] ."'";
...
?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Data Potongan</h1>
          <!-- DataTales Example -->
				...
				<div class="row">
					<div class="col-lg-12 col-md-12">										
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								...
								<?php
									...
									<input type="hidden" name="id" class="form-control" placeholder="ID" value="<?php echo $data['pot_id'] ?>" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-form-label col-sm-3" align="right">Tanggal</label>
							<div class="col-sm-6">
								<input type="date" name="tgl" class="form-control" value="<?php echo $data['pot_tgl'];?>" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-form-label col-sm-3" align="right">Jumlah</label>
							<div class="col-sm-6">
								<input type="number" name="jml" min="0" class="form-control" placeholder="Jumlah" value="<?php echo $data['pot_jml'];?>" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-form-label col-sm-3" align="right">Keterangan</label>
							<div class="col-sm-6">
								<textarea name="ket" class="form-control" required><?php echo $data['pot_ket'];?></textarea>
							</div>
						</div>
						<hr/>
						</div>
						<div class="panel-footer">
							...
							<a href="potongan.php" class="btn btn-info">Batal</a>
						</div>
						</div><!-- /.panel -->
						</form>
					</div><!-- /.col-lg-12 -->
