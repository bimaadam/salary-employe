<?php
 ...
 if(isset($_GET['lem'])) {
		$sql = "SELECT * FROM lembur WHERE lembur_id='". $_GET['lem'] ."'";
	...
	if(isset($_POST['perbarui'])) {
		...
		if($mulai>$selesai){
				echo "<script>alert('Jam mulai tidak boleh lebih dari jam selesai!');</script>";
            ...
            <div class="card-body">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12">										
						...
						<div class="form-group row">
							<label class="col-form-label col-sm-3" align="right">Mulai</label>
							<div class="col-sm-6">
								<input type="time" name="mulai" class="form-control" placeholder="Rate lembur" value="<?php echo $data['lembur_mulai'] ?>" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-form-label col-sm-3" align="right">Selesai</label>
							<div class="col-sm-6">
								<input type="time" name="selesai" class="form-control" placeholder="Rate lembur" value="<?php echo $data['lembur_selesai'] ?>" required>
							</div>
						</div>
						<hr/>
						</div>
						<div class="panel-footer">
							...
							<a href="lembur.php" class="btn btn-info">Batal</a>
						</div>
						</div><!-- /.panel -->
						</form>
					</div><!-- /.col-lg-12 -->
