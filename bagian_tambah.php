<?php
 ...
 if(isset($_POST['simpan'])){
		...
		$lembur = $_POST['lembur'];
		$wd = "BGN";
		$no = buatKode("bagian",$wd);
		
		$sql  = "INSERT INTO bagian(bagian_id,bagian_nama,bagian_gaji,bagian_lembur)VALUES('$no','$nama','$gaji','$lembur')";
				...
				<div class="row">
					<div class="col-lg-12 col-md-12">										
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<input type="text" name="nama" class="form-control" placeholder="Nama Bagian" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-form-label col-sm-3" align="right">Gaji Pokok</label>
							<div class="col-sm-6">
								<input type="number" min=0 name="gaji" class="form-control" placeholder="Gaji Pokok" required>
							</div>
						</div>
						<div class="form-group row">
