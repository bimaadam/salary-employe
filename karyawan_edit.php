<?php
 ...
 include("sess_check.php");
	...
	if(isset($_GET['kry'])) {
		$sql = "SELECT karyawan.*, bagian.* FROM karyawan, bagian 
				WHERE karyawan.bagian_id=bagian.bagian_id
            ...
            <div class="card-body">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12">										
						<form class="user" action="karyawan_update.php" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group row">
							<label class="col-form-label col-sm-3" align="right">Jenis Kelamin</label>
							<div class="col-sm-6">
						...
						<div class="form-group row">
							<label class="col-form-label col-sm-3" align="right">Mulai Bekerja</label>
							<div class="col-sm-6">
						...
						<div class="panel-footer">
							...
							<a href="karyawan.php" class="btn btn-info">Batal</a>
						</div>
						</div><!-- /.panel -->
						</form>
					</div><!-- /.col-lg-12 -->
