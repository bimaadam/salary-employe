<?php
 ...
 include("sess_check.php");
	...
	if(isset($_POST['simpan'])) {
		...
		$wd = "TRX";
		$no = buatKode("jurnal",$wd);
		
		$sql = "INSERT INTO jurnal(jurnal_trx,jurnal_reff,jurnal_tgl,akun_kode,jurnal_jml,jurnal_ket,jurnal_bl,jurnal_th)
				VALUES('$no','$ref','$tgl','$akun','$jml','$ket','$bl','$th')";
		...
		//	echo("Error description: " . mysqli_error($conn));
			...
			echo "<script type='text/javascript'> document.location = 'jurnal_tambah.php'; </script>";
		}
	}
?>
<!DOCTYPE html>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12">										
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<input type="text" name="ref" class="form-control" placeholder="Nomor Referensi" required>
							</div>
						</div>
						<div class="form-group row">
