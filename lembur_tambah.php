<?php
 ...
 include("sess_check.php");
	...
	if(isset($_POST['simpan'])) {
		...
		$mulai = addslashes($_POST['mulai']);
		$selesai = addslashes($_POST['selesai']);
		$bl = substr($tgl,5,2);
		$th = substr($tgl,0,4);
		...
		if($mulai>$selesai){
			...
			$sql = "INSERT INTO lembur(lembur_tgl,lembur_jam,karyawan_id,lembur_mulai,lembur_selesai,lembur_bl,lembur_th)
					VALUES('$tgl','$intot','$kry','$mulai','$selesai','$bl','$th')";
