  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-6 col-md-9">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="p-5">
					...
					<h2 class="text-center">Rinbim.dev</h2>
					<br/>
        ...
        <!-- <button class="btn btn-primary align-center" name="daftar" value="Daftar">Daftar</button> -->
                  <br>
                  <center><p>Dev by <a href='https://github.com/bimaadam/' title='bimaadamrin.my.id' target='_blank'>Bima Adam</a></p></center>
