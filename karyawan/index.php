<?php
	...
	$sqlkry = "SELECT * FROM gaji_karyawan WHERE karyawan_id='$sess_kryid'";
	$resskry = mysqli_query($conn, $sqlkry);
	$kry = mysqli_num_rows($resskry);

	$sqlapp = "SELECT * FROM gaji_karyawan WHERE gaj_stt='Menunggu Approval' AND karyawan_id='$sess_kryid'";
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><a href="gaji.php">Gaji</a></div>
            ...
            <div class="col-xl-6 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><a href="#">Menunggu Approval</a></div>
