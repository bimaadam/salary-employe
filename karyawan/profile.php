<?php
 ...
 $sql = "SELECT * FROM karyawan WHERE karyawan_id='$sess_kryid'";
...
?>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
				<div align="center"><img src="../img/<?php echo $data['karyawan_foto']?>" width="150px"></div>
				<br/>
				<div class="row">
					<div class="col-lg-12 col-md-12">										
						<form class="user" action="" method="POST" enctype="multipart/form-data">
						<div class="form-group row">
							<label class="col-form-label col-sm-3" align="right">Karyawan ID</label>
							<div class="col-sm-6">
								<input type="text" name="id" class="form-control" placeholder="id" value="<?php echo $data['karyawan_id'];?>" readonly>
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<input type="number" name="telp" class="form-control" placeholder="Telepon" value="<?php echo $data['karyawan_telp'];?>" required>
							</div>
						</div>
						<div class="form-group row">
