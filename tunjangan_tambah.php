<?php
 ...
 include("sess_check.php");
	...
	if(isset($_POST['simpan'])) {
		...
		$bl = substr($tgl,5,2);
		$th = substr($tgl,0,4);
		$sql = "INSERT INTO tunjangan(karyawan_id,tjg_tgl,tjg_jml,tjg_ket,tjg_bl,tjg_th)
		...
		//	echo("Error description: " . mysqli_error($conn));
			...
			echo "<script type='text/javascript'> document.location = 'tunjangan_tambah.php'; </script>";
		}
	}
?>
<!DOCTYPE html>
