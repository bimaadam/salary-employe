			...
			<br />	
				...
				<?php
					...
					while($data=mysqli_fetch_array($ress)){
						...
						echo '<td class="text-center">'. format_rupiah($data['gaj_pok']) .'</td>';
						echo '<td class="text-center">'. format_rupiah($data['gaj_tjg']) .'</td>';
						echo '<td class="text-center">'. format_rupiah($data['gaj_lembur']) .'</td>';
						echo '<td class="text-center">'. format_rupiah($data['gaj_pot']) .'</td>';
